...
\begin{figure}[!htb]
    \begin{center}
        \subfloat[Top side.\label{fig:edc-top-test}]{\includegraphics[width=0.48\textwidth]{figures/edc_report/edcs-top}}
        ~
        \subfloat[Bottom side.\label{fig:edc-bottom-test}]{\includegraphics[width=0.48\textwidth]{figures/edc_report/edcs-bottom}}
