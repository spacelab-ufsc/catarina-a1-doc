...
\begin{figure}[!htb]
    \begin{center}
        \subfloat[Top side.\label{fig:edc-top-test}]{\includegraphics[width=\textwidth]{figures/edc_report/edcs-top}}
        ~
        \subfloat[Bottom side.\label{fig:edc-bottom-test}]{\includegraphics[width=\textwidth]{figures/edc_report/edcs-bottom}}
