...
\begin{itemize}
    ...
    \item $h$ = Satellite altitude = 500 km
...
The minimum distance between the satellite and a ground station is the satellite altitude, in this case: 500 km. The maximum distance is the distance at the horizon, defined by \autoref{eq:horizon-distance-result}.
...
\begin{itemize}
    \item Downlink: $SNR^{dB} \geq 9,6\ dB$
    \item Uplink: $SNR^{dB} \geq 9,6\ dB$
...
\begin{itemize}
    \item Downlink: $16,48 - 9,6 = \mathbf{6,88\ dB}$
    \item Uplink: $31,88 - 9,6 = \mathbf{22,28\ dB}$
    \item Uplink (payload): $19,67 - 9,6 = \mathbf{10,07\ dB}$
\end{itemize}
